...
// Mode : shift data
unsigned int lastMsg_shift_data = 0;
const unsigned int interval_shift_data = 3000;


// Mode : W
unsigned int lastMsg_mqtt_w = 0;
const unsigned int interval_mqtt_w = 5000;


// Mode : HB
unsigned int lastMsg_mqtt_hb = 0;
const unsigned int interval_mqtt_hb = 10000;
...
// Interval Read sensor
unsigned int lastMsg_sensor = 0;
const unsigned int interval_sensor = 5000;
...
#define add_ssid 0
#define add_passw 30
#define add_cnt_payload 60
#define add_cnt_group_payload 70
#define add_unix_time 90
